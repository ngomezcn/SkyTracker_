...
fun FlowContent.satelliteDetail(sat: SatelliteDAO, comments : List<SatCommentDAO>, isTracking : Boolean, application: Application) {
        ...
        section("py-5") {
            form {
                //action = application.href(Satellites.NoradId)
                method = FormMethod.post
                encType = FormEncType.multipartFormData
