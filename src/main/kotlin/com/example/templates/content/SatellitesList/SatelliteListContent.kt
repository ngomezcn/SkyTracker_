...
class SatelliteList(val sats: List<SatelliteDAO>): Template<FlowContent> {
...
class SatelliteListContent : Template<FlowContent> {
    ...
    private val satelliteList = TemplatePlaceholder<SatelliteList>()

    var page: Int? = null
    lateinit var sats: List<SatelliteDAO>
    private val itemsXPage: Long = 1000; // of 42000 aprox
    ...
    override fun FlowContent.apply() {
        ...
        div("row no-gutters") {
            ...
            div("col-6 col-md-4") {
                insert(SatelliteList(sats), satelliteList)
            }
        }
